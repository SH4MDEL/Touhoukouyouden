...
void CLIENT::SendAddPlayer(INT id)
{
	...
	DoSend(&sendpk);
#ifdef NETWORK_DEBUG
	cout << "SC_PACKET_ADD_PLAYER 송신 - ID : " << m_id << ", x : " << sendpk.coord.x << ", y : " << sendpk.coord.y << endl;
#endif
}
...
void CLIENT::SendObjectInfo(INT id)
{
	...
	DoSend(&sendpk);
#ifdef NETWORK_DEBUG
	cout << "SC_PACKET_OBJECT_INFO 송신 - ID : " << m_id << ", x : " << sendpk.coord.x << ", y : " << sendpk.coord.y << endl;
#endif
}
...
#ifdef NETWORK_DEBUG
	cout << "SC_PACKET_CHAT 송신 - ID : " << m_id;
#endif
}
...
#ifdef NETWORK_DEBUG
	cout << "SC_PACKET_EXIT_PLAYER 송신 - ID : " << m_id << endl;
#endif
}
